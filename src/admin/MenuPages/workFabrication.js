...
const WorkFabrication = () => {
    ...
    const submitWork3d = async (e) => {
        try {
            ...
            axios.post(`${url}/fabrication.php`, formData)
                .then(res => {
    ...
    const onEdit = (ids) => {
        ...
        try {
          axios.post(`${url}/fabrication.php`, {
            userids: ids,
                ...
                <div className="modal-dialog modal-xl">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title text-danger" id="exampleModalLabel">Fabrication Pages Edit</h5>
...
export default WorkFabrication ;