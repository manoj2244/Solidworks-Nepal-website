...
const Design_Simula = () => {
    ...
    const submitWork3d = async (e) => {
        try {
            ...
            axios.post(`${url}/design_simula.php`, formData)
                .then(res => {
    ...
    const onEdit = (ids) => {
        ...
        try {
          axios.post(`${url}/design_simula.php`, {
            userids: ids,
                ...
                <div className="modal-dialog modal-xl">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-access text-danger" id="exampleModalLabel">Design_Simula Pages Edit</h5>
