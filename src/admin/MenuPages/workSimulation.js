...
const WorkSimulation = () => {
    ...
    const submitWork3d = async (e) => {
        try {
            ...
            axios.post(`${url}/worksimu.php`, formData)
                .then(res => {
        ...
        <div className="admin-main">
                ...
                <div className="modal-dialog modal-xl">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title text-danger" id="exampleModalLabel">Simulation Pages Edit</h5>
            ...
            <main id="main" className="main">
                ...
                <div className="container my-4">
                    <h2>Project - Simulation and Optimization</h2>
